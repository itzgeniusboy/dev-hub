...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "dev.hub.desktop.dev"
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "Dev Hub Dev")
  ...
  app.setAsDefaultProtocolClient("dev-hub")
  registerRendererProtocol()
  setDockIcon()
