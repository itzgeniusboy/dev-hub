...
const appId = channel === "prod" ? "dev.hub.desktop" : `dev.hub.desktop.${channel}`
const productName = channel === "prod" ? "Dev Hub" : `Dev Hub ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      Dev Hub is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
