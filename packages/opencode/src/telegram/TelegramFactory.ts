...
const HUB_ROOT = join(TermuxAdapter.homePath, ".devhub")
const BOT_ROOT = join(HUB_ROOT, "bots")
const TEMPLATE_ROOT = process.env.DEV_HUB_TEMPLATE_ROOT || join(import.meta.dir, "templates")
declare const DEV_HUB_EMBEDDED_TEMPLATES: Record<string, Record<string, string>>
const embeddedTemplates: Record<string, Record<string, string>> =
  typeof DEV_HUB_EMBEDDED_TEMPLATES === "undefined" ? {} : DEV_HUB_EMBEDDED_TEMPLATES
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Dev Hub bot is online.")
