...
import { ResizeHandle } from "@nexus-ai/ui/resize-handle"
...
import { Session } from "@nexus-ai/sdk/v2/client"
...
import { retry } from "@nexus-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@nexus-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://nexus.ai/desktop-feedback")}
      renderPanel={() =>
