...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Dev Hub.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Dev Hub.",
  ...
  "dialog.server.description": "Switch which Dev Hub server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Dev Hub in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Dev Hub in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Dev Hub in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Dev Hub in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Dev Hub can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Dev Hub ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Dev Hub team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Dev Hub does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Dev Hub server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Dev Hub",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Dev Hub looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Dev Hub follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Dev Hub is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Dev Hub launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Dev Hub.",
