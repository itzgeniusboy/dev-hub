export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Dev Hub",
  ...
  "desktop.menu.ariaLabel": "Dev Hub meni",
  ...
  "desktop.recovery.loadFailed": "Dev Hub se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Dev Hub-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Dev Hub ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Dev Hub-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Dev Hub-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Dev Hub-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Dev Hub-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Dev Hub-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Dev Hub server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Dev Hub u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Dev Hub u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Dev Hub u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Dev Hub u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Dev Hub mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Dev Hub-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Dev Hub timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Dev Hub još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Dev Hub server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Dev Hub-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Dev Hub izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Dev Hub prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Dev Hub-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Dev Hub pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Dev Hub-a.",
