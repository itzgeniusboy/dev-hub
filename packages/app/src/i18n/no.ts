...
export const dict = {
  ...
  "desktop.menu.documentation": "Dev Hub-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Dev Hub-meny",
  ...
  "desktop.recovery.loadFailed": "Dev Hub kunne ikke lastes inn",
  "desktop.recovery.terminated": "Dev Hub-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Dev Hub svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Dev Hub mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Dev Hub er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Dev Hub.",
  ...
  "dialog.server.description": "Bytt hvilken Dev Hub-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Dev Hub ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Dev Hub-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Dev Hub ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Dev Hub-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Dev Hub",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Dev Hub ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Dev Hub skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Dev Hub starter",
  ...
  "settings.updates.toast.latest.title": "Dev Hub er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Dev Hub.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Dev Hub i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Dev Hub i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Dev Hub i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Dev Hub i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Dev Hub kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Dev Hub på nytt.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
