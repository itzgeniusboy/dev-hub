...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub failed to load",
  "desktop.recovery.terminated": "Dev Hub window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Dev Hub is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Dev Hub update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
