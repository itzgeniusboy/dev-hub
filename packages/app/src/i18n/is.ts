...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Dev Hub",
  "Dev Hub-glugganum var óvænt lokað",
  "Dev Hub svarar ekki",
  ...
  "Dev Hub er ekki uppsett í {{distro}}",
  "Uppfærslu Dev Hub lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Dev Hub.",
  ...
  "dialog.server.description": "Skiptu um hvaða Dev Hub miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Dev Hub í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Dev Hub í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Dev Hub í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Dev Hub í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Dev Hub getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Dev Hub aftur.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Dev Hub ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Dev Hub teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Dev Hub styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Dev Hub inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Dev Hub skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Dev Hub netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Dev Hub",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Dev Hub lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Dev Hub fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Dev Hub er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Dev Hub ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Dev Hub.",
