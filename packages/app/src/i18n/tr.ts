...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub yüklenemedi",
  "desktop.recovery.terminated": "Dev Hub penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Dev Hub yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Dev Hub güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hub tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Dev Hub'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Dev Hub'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Dev Hub'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Dev Hub sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Dev Hub kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Dev Hub güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Dev Hub güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Dev Hub'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Dev Hub'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Dev Hub hazır.",
  "wsl.onboarding.opencodeReady": "Dev Hub hazır.",
  "wsl.onboarding.installOpencodeIn": "Dev Hub'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Dev Hub'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Dev Hub'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Dev Hub'u tekrar açın.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hub'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Dev Hub ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Dev Hub henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Dev Hub Masaüstü",
  ...
  "settings.desktop.wsl.description": "Dev Hub sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Dev Hub'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Dev Hub'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Dev Hub'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Dev Hub'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Dev Hub başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Dev Hub'un en son sürümünü kullanıyorsunuz.",
