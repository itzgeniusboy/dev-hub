export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Dev Hub",
  ...
  "desktop.menu.ariaLabel": "Menú de Dev Hub",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Dev Hub",
  "desktop.recovery.terminated": "La ventana de Dev Hub se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Dev Hub no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Dev Hub finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Dev Hub.",
  ...
  "dialog.server.description": "Cambiar el servidor de Dev Hub al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Dev Hub en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Dev Hub en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Dev Hub en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Dev Hub en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Dev Hub pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Dev Hub ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Dev Hub",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Dev Hub aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Dev Hub dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Dev Hub",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Dev Hub en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Dev Hub sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Dev Hub.",
