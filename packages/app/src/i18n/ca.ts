export const dict = {
  ...
  "desktop.menu.documentation": "Dev Hub Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Dev Hub.",
  ...
  "desktop.recovery.loadFailed": "Dev Hub no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Dev Hub s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Dev Hub no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Dev Hub ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Dev Hub actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Dev Hub.",
  ...
  "dialog.server.description": "Canvia a quin Dev Hub servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Dev Hub a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Dev Hub a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Dev Hub a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Dev Hub a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Dev Hub pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Dev Hub ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Dev Hub.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Dev Hub encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Dev Hub Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Dev Hub dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Dev Hub",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Dev Hub al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Dev Hub segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Dev Hub.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Dev Hub.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Dev Hub.",
