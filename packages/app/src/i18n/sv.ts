export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub kunde inte läsas in",
  "desktop.recovery.terminated": "Dev Hub-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Dev Hub svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Dev Hub misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Dev Hub-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Dev Hub.",
  ...
  "dialog.server.description": "Växla vilken Dev Hub-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Dev Hub i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Dev Hub i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Dev Hub i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Dev Hub i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Dev Hub kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Dev Hub igen.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Dev Hub ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Dev Hub-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Dev Hub stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Dev Hub-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Dev Hub",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Dev Hub ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Dev Hub följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Dev Hubs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Dev Hub startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Dev Hub.",
