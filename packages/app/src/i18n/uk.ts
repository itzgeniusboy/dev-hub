export const dict = {
  ...
  "desktop.menu.documentation": "Документація Dev Hub",
  ...
  "desktop.menu.ariaLabel": "Меню Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Dev Hub",
  "desktop.recovery.terminated": "Роботу вікна Dev Hub несподівано завершено",
  "desktop.recovery.unresponsive": "Dev Hub не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Dev Hub завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Dev Hub.",
  ...
  "dialog.server.description": "Перемкніть сервер Dev Hub, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Dev Hub у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Dev Hub у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Dev Hub у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Dev Hub у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Dev Hub потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Dev Hub ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Dev Hub",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Dev Hub ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Dev Hub всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Dev Hub",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Dev Hub на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Dev Hub використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Dev Hub.",
