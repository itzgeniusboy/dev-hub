export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Dev Hub gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Dev Hub ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Dev Hub tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Dev Hub gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Dev Hub selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Dev Hub.",
  ...
  "dialog.server.description": "Tukar pelayan Dev Hub yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Dev Hub dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Dev Hub dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Dev Hub dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Dev Hub dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Dev Hub boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Dev Hub ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Dev Hub",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Dev Hub belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Dev Hub dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Dev Hub",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Dev Hub pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Dev Hub mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Dev Hub dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Dev Hub.",
