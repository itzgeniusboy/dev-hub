export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Dev Hub.",
  ...
  "dialog.server.description": "Skift hvilken Dev Hub-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Dev Hub i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Dev Hub i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Dev Hub i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Dev Hub kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Dev Hub igen.",
  ...
  "toast.update.description": "En ny version af Dev Hub ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Dev Hub-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Dev Hub understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Dev Hub-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Dev Hub",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Dev Hub ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Dev Hub skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Dev Hubs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Dev Hub starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Dev Hub.",
  ...
  "desktop.recovery.loadFailed": "Dev Hub kunne ikke indlæses",
  "desktop.recovery.terminated": "Dev Hub-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Dev Hub mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Dev Hub er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Dev Hub Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
