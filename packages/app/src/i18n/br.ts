export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Dev Hub",
  ...
  "desktop.menu.ariaLabel": "Menu do Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Dev Hub",
  "desktop.recovery.terminated": "A janela do Dev Hub foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Dev Hub não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Dev Hub não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Dev Hub foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Dev Hub.",
  ...
  "dialog.server.description": "Trocar para qual servidor Dev Hub este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Dev Hub em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Dev Hub em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Dev Hub em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "O Dev Hub está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Dev Hub está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Dev Hub em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Dev Hub possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Dev Hub não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Dev Hub novamente.",
  ...
  "help.tabs.introduction": "Agora, o Dev Hub Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Dev Hub ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Dev Hub",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Dev Hub ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Dev Hub dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Dev Hub",
  ...
  "settings.general.row.appearance.description": "Personalize como o Dev Hub aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Dev Hub segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Dev Hub é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Dev Hub iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Dev Hub.",
