export const dict = {
  ...
  "desktop.menu.documentation": "Dev Hub دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Dev Hub مینو",
  ...
  "desktop.recovery.loadFailed": "Dev Hub لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Dev Hub ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Dev Hub جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Dev Hub انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Dev Hub کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hub کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Dev Hub میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Dev Hub میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Dev Hub میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Dev Hub سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Dev Hub چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Dev Hub کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Dev Hub کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Dev Hub کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Dev Hub کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Dev Hub تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Dev Hub انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Dev Hub انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Dev Hub WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Dev Hub کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Dev Hub Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hub ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Dev Hub ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Dev Hub ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Dev Hub ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Dev Hub سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Dev Hub کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Dev Hub کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Dev Hub سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Dev Hub کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Dev Hub لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Dev Hub کا تازہ ترین ورژن چلا رہے ہیں۔",
