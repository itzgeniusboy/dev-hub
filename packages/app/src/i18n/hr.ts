...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Dev Hub se nije uspio učitati",
  "Prozor aplikacije Dev Hub neočekivano je zatvoren",
  "Dev Hub ne reagira",
  ...
  "Instalacija aplikacije Dev Hub nije uspjela",
  ...
  "Dev Hub nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Dev Hub je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Dev Hub.",
  ...
  "dialog.server.description": "Promijenite na koji se Dev Hub poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Dev Hub u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Dev Hub u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Dev Hub u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Dev Hub u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Dev Hub",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Dev Hub može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Dev Hub.",
  ...
  "help.tabs.introduction": "Radna površina Dev Hub sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Dev Hub ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Dev Hub timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Dev Hub još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Dev Hub Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Dev Hub poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Dev Hub",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Dev Hub izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Dev Hub slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Dev Hub tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Dev Hub pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Dev Hub.",
