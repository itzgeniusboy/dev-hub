...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub 加载失败",
  "desktop.recovery.terminated": "Dev Hub 窗口意外终止",
  "desktop.recovery.unresponsive": "Dev Hub 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Dev Hub",
  "desktop.wsl.error.updateVersion":
    "Dev Hub 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hub 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Dev Hub 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Dev Hub Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Dev Hub 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Dev Hub 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Dev Hub 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Dev Hub...",
  "wsl.onboarding.updatingOpencode": "正在更新 Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Dev Hub...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Dev Hub。",
  "wsl.onboarding.updateOpencode": "更新 Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Dev Hub 已就绪。",
  "wsl.onboarding.opencodeReady": "Dev Hub 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Dev Hub。",
  "wsl.onboarding.installOpencode": "安装 Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Dev Hub",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Dev Hub 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Dev Hub。",
  ...
  "help.tabs.introduction": "Dev Hub Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hub 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Dev Hub 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Dev Hub 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Dev Hub 服务器。",
  ...
  "settings.general.row.language.description": "更改 Dev Hub 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Dev Hub 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Dev Hub 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Dev Hub 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Dev Hub 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Dev Hub。",
