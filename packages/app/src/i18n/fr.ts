export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Dev Hub",
  "desktop.recovery.terminated": "La fenêtre Dev Hub s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Dev Hub ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Dev Hub est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Dev Hub.",
  ...
  "dialog.server.description": "Changez le serveur Dev Hub auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Dev Hub dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Dev Hub dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Dev Hub dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Dev Hub dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Dev Hub puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Dev Hub ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Dev Hub",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Dev Hub ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Dev Hub inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Dev Hub dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Dev Hub",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Dev Hub sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Dev Hub suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Dev Hub.",
