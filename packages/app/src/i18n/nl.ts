export const dict = {
  ...
  "desktop.menu.documentation": "Dev Hub-documentatie",
  ...
  "desktop.recovery.loadFailed": "Dev Hub kan niet worden geladen",
  "desktop.recovery.terminated": "Het Dev Hub-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Dev Hub reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Dev Hub is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Dev Hub-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Dev Hub te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Dev Hub te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Dev Hub te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Dev Hub-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Dev Hub controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dev Hub bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Dev Hub bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Dev Hub bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dev Hub bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Dev Hub in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Dev Hub een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Dev Hub opnieuw.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Dev Hub ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Dev Hub-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Dev Hub ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Dev Hub-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Dev Hub",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Dev Hub eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Dev Hub het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Dev Hub aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Dev Hub wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Dev Hub is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Dev Hub.",
