export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Không tải được Dev Hub",
  "desktop.recovery.terminated": "Cửa sổ Dev Hub đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Dev Hub không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Dev Hub nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Dev Hub cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Dev Hub.",
  ...
  "dialog.server.description": "Chuyển máy chủ Dev Hub mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Dev Hub trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Dev Hub trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Dev Hub trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Dev Hub trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Dev Hub có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Dev Hub ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Dev Hub",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Dev Hub chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Dev Hub bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Dev Hub",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Dev Hub trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Dev Hub tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Dev Hub khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Dev Hub.",
