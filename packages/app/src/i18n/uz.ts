export const dict = {
  ...
  "desktop.menu.documentation": "Dev Hub hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Dev Hub menyusi",
  ...
  "desktop.recovery.loadFailed": "Dev Hub yuklanmadi",
  "desktop.recovery.terminated": "Dev Hub oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Dev Hub javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Dev Hub yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hub tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Dev Hub’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Dev Hub da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Dev Hub da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Dev Hub serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Dev Hub {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Dev Hub yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Dev Hub {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Dev Hub-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Dev Hub-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Dev Hub tayyor.",
  "wsl.onboarding.installOpencodeIn": "Dev Hub-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Dev Hub-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Dev Hub WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Dev Hub-ni qayta oching.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hub ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Dev Hub jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Dev Hub hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Dev Hub bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Dev Hub serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Dev Hub uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Dev Hub qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Dev Hub tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Dev Hub mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Dev Hub ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Dev Hub oxirgi versiyasini ishga tushiryapsiz.",
