export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Dev Hub",
  ...
  "desktop.menu.ariaLabel": "Meniu Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Dev Hub nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Dev Hub s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Dev Hub nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Dev Hub a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Dev Hub s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Dev Hub.",
  ...
  "dialog.server.description": "Schimbă serverul Dev Hub la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Dev Hub în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Dev Hub în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Dev Hub în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Dev Hub în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Dev Hub să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Dev Hub ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Dev Hub",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Dev Hub nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Dev Hub în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Dev Hub",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Dev Hub pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Dev Hub urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Dev Hub.",
