export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Dev Hub.",
  ...
  "dialog.server.description": "Cambia il server Dev Hub a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Dev Hub in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Dev Hub in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Dev Hub in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Dev Hub in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Dev Hub possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Dev Hub ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Dev Hub",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Dev Hub non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Dev Hub all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Dev Hub",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Dev Hub sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Dev Hub segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Dev Hub",
  ...
  "settings.updates.toast.latest.title": "Dev Hub è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Dev Hub.",
  ...
  "desktop.menu.documentation": "Documentazione di Dev Hub",
  ...
  "desktop.menu.ariaLabel": "Menu Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Dev Hub",
  "desktop.recovery.terminated": "La finestra di Dev Hub si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Dev Hub non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Dev Hub non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Dev Hub è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
