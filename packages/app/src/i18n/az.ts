export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub yüklənə bilmədi",
  "desktop.recovery.terminated": "Dev Hub pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Dev Hub cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Dev Hub yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hub tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Dev Hub-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Dev Hub-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Dev Hub-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Dev Hub serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Dev Hub yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Dev Hub yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Dev Hub yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Dev Hub-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Dev Hub-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Dev Hub hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Dev Hub-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Dev Hub quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Dev Hub WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Dev Hub-u yenidən açın.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hub-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Dev Hub komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Dev Hub hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Dev Hub serverini işlət.",
  ...
  "settings.general.row.language.description": "Dev Hub üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Dev Hub-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Dev Hub-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Dev Hub-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Dev Hub açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Dev Hub-un ən son versiyasından istifadə edirsiniz.",
