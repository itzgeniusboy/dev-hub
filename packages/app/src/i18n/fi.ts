export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hubn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Dev Hubssa.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Dev Hubssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Dev Hubssa.",
  ...
  "dialog.server.description": "Vaihda Dev Hub-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Dev Huba...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Dev Huba kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Dev Huba...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Dev Huba kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Dev Hub jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Dev Hub jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Huba ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Dev Hub voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Dev Hub uudelleen.",
  ...
  "toast.update.description": "Dev Hubn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Dev Hub-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Dev Hub ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Dev Hub-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Dev Hubn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Dev Hub näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Dev Hub järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Dev Hubn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Dev Hub käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Dev Hubn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Dev Hub-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Dev Hub-valikko",
  ...
  "desktop.recovery.loadFailed": "Dev Hubn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Dev Hub-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Dev Hub ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hubn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Huba ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Dev Hubn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Dev Hub Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
