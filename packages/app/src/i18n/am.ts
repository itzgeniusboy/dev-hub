export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub መጫን አልቻለም",
  "desktop.recovery.terminated": "Dev Hub መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Dev Hub ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hubመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Dev Hub ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በDev Hub",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በDev Hub ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "Dev Hub ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በDev Hub ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በDev Hub ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Dev Hub አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Dev Hubን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Dev Hub በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Dev Hub በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Dev Hub ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Dev Hub በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hubአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Dev Hub WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Dev Hub።",
  ...
  "help.tabs.introduction": "Dev Hub ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የDev Hub ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለDev Hub ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Dev Hub እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Dev Hub ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የDev Hub አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለDev Hub",
  ...
  "settings.general.row.appearance.description": "Dev Hubበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Dev Hub ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Dev Hub ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Dev Hub ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የDev Hub እትም እያሄዱ ነው።",
