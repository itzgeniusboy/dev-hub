export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Dev Hub",
  "desktop.recovery.terminated": "Okno Dev Hub zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Dev Hub nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Dev Hub została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Dev Hub.",
  ...
  "dialog.server.description": "Przełącz serwer Dev Hub, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Dev Hub w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Dev Hub w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Dev Hub w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Dev Hub w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Dev Hub będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Dev Hub ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Dev Hub",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Dev Hub nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Dev Hub zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Dev Hub wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Dev Hub",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Dev Hub na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Dev Hub ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Dev Hub.",
