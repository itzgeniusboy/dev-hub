export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hubを読み込めませんでした",
  "desktop.recovery.terminated": "Dev Hubのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Dev Hubが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hubのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはDev Hubがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Dev Hubのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hubが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Dev Hubで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してDev Hubで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Dev Hubで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するDev Hubサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hubを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のDev Hubを確認中...",
  "wsl.onboarding.updatingOpencode": "Dev Hubを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のDev Hubを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のDev Hubを更新してください。",
  "wsl.onboarding.updateOpencode": "Dev Hubを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のDev Hubの準備ができました。",
  "wsl.onboarding.opencodeReady": "Dev Hubの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にDev Hubをインストールしてください。",
  "wsl.onboarding.installOpencode": "Dev Hubをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hubがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Dev HubでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Dev Hubをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Dev Hub Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hubの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをDev Hubチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Dev HubはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Dev Hubには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でDev Hubサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Dev Hubの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのDev Hubの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Dev Hubがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Dev Hubのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Dev Hub の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Dev Hub は最新バージョンです。",
