...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub 載入失敗",
  "desktop.recovery.terminated": "Dev Hub 視窗意外終止",
  "desktop.recovery.unresponsive": "Dev Hub 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Dev Hub",
  "desktop.wsl.error.updateVersion":
    "Dev Hub 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Dev Hub 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Dev Hub 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Dev Hub Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Dev Hub 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Dev Hub 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Dev Hub 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Dev Hub...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Dev Hub 已就緒。",
  "wsl.onboarding.opencodeReady": "Dev Hub 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Dev Hub。",
  "wsl.onboarding.installOpencode": "安裝 Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Dev Hub",
  ...
  "wsl.onboarding.wslUnavailable.description": "Dev Hub 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Dev Hub。",
  ...
  "help.tabs.introduction": "Dev Hub Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dev Hub 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Dev Hub 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Dev Hub 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Dev Hub 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Dev Hub 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Dev Hub 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Dev Hub 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Dev Hub 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Dev Hub 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Dev Hub 啟動時自動檢查更新",
