export const dict = {
  ...
  "desktop.menu.documentation": "Dev Hub Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Dev Hub",
  ...
  "desktop.recovery.loadFailed": "Dev Hub se nepodařilo načíst",
  "desktop.recovery.terminated": "Dev Hub okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Dev Hub nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Dev Hub aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Dev Hub.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Dev Hub serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Dev Hub v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Dev Hub v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Dev Hub v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Dev Hub do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Dev Hub může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Dev Hub ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Dev Hub",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Dev Hub zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Dev Hub uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Dev Hub",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Dev Hub na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Dev Hub následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Dev Hub.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Dev Hub.",
