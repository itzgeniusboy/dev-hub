...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Dev Hub zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Dev Hub zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Dev Hub zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Dev Hub-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Dev Hub",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Dev Hub in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Dev Hub wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Dev Hub in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Dev Hub in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dev Hub aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Dev Hub ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Dev Hub in {{distro}}.",
  "wsl.onboarding.installOpencode": "Dev Hub installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Dev Hub einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Dev Hub erneut.",
  ...
  "toast.update.description": "Eine neue Version von Dev Hub ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Dev Hub-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Dev Hub unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Dev Hub mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Dev Hub enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Dev Hub Desktop",
  ...
  "settings.desktop.wsl.description": "Dev Hub-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Dev Hub ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Dev Hub auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Dev Hub dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Dev Hub anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Dev Hub automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Dev Hub ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Dev Hub wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Dev Hub konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Dev Hub-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Dev Hub reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Dev Hub-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Dev Hub Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
