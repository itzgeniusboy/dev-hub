export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Dev Hub aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Dev Hub ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Dev Hub installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Dev Hub värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Dev Hub'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Dev Hub.",
  ...
  "dialog.server.description": "Lülitage, millise Dev Hub serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Dev Hub kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Dev Hub kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dev Hub värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Dev Hub värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Dev Hub jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Dev Hub asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Dev Hub saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Dev Hub ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Dev Hub meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Dev Hub ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Dev Hub Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Dev Hub server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Dev Hub kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Dev Hub teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Dev Hub järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Dev Hub on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Dev Hub käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Dev Hub uusimat versiooni.",
