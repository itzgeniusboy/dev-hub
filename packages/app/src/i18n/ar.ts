export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Dev Hub",
  "desktop.recovery.terminated": "توقفت نافذة Dev Hub بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Dev Hub لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Dev Hub",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Dev Hub، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Dev Hub Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Dev Hub.",
  ...
  "dialog.server.description": "تبديل خادم Dev Hub الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Dev Hub في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Dev Hub في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Dev Hub في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Dev Hub في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Dev Hub من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Dev Hub التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Dev Hub.",
  ...
  "help.tabs.introduction": "أصبح Dev Hub Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Dev Hub ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Dev Hub",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Dev Hub لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Dev Hub نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Dev Hub داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Dev Hub",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Dev Hub على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Dev Hub يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Dev Hub.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Dev Hub",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Dev Hub.",
