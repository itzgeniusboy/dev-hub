...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Dev Hub įkelti nepavyko",
  "Dev Hub langas netikėtai užsidarė",
  "Dev Hub neatsako",
  ...
  "Dev Hub įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Dev Hub neįdiegtas distributyve {{distro}}",
  "Dev Hub naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Dev Hub modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Dev Hub.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Dev Hub serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Dev Hub {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Dev Hub {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Dev Hub {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Dev Hub į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Dev Hub galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Dev Hub ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Dev Hub komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Dev Hub dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Dev Hub apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Dev Hub darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Dev Hub serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Dev Hub ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Dev Hub atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Dev Hub seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Dev Hub temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Dev Hub",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Dev Hub versiją.",
