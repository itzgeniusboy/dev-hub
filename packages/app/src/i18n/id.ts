export const dict = {
  ...
  "desktop.recovery.loadFailed": "Dev Hub gagal dimuat",
  "desktop.recovery.terminated": "Jendela Dev Hub berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Dev Hub tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Dev Hub gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Dev Hub belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Dev Hub selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Dev Hub",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Dev Hub.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dev Hub Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Dev Hub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Dev Hub.",
  ...
  "dialog.server.description": "Ganti server Dev Hub mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Dev Hub...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Dev Hub di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Dev Hub...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Dev Hub di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Dev Hub di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Dev Hub",
  "wsl.onboarding.opencodeReadyIn": "Dev Hub siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Dev Hub siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Dev Hub di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Dev Hub",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Dev Hub belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Dev Hub dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Dev Hub tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Dev Hub.",
  ...
  "help.tabs.introduction": "Dev Hub Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Dev Hub ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Dev Hub",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Dev Hub belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Dev Hub menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Dev Hub di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Dev Hub",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Dev Hub di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Dev Hub mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Dev Hub diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Dev Hub.",
