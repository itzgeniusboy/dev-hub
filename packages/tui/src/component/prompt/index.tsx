...
import { registerNexusSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@nexus-ai/sdk/v2"
...
import { NEXUS_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useNexusKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NEXUS_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
